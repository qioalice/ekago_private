...
//
// What you CAN do with functions and their addresses using TakeRealAddr():
//
//	func foo() {}
//	type T struct{}
//	func (_ T) bar() {}
...
// and be able to call a function address of which you've got by TakeRealAddr(),
// you need to pass it to Addr2Callable() or just use TakeCallableAddr().
func TakeRealAddr(i any) unsafe.Pointer {
	return UnpackInterface(i).Word
}

// TakeCallableAddr extends TakeRealAddr functionality,
// providing you a mechanism to get a real address of any function,
// using which you may:
//
...
// convert addresses to functions, vice-versa and call them,
// but you can also avoid type checks while any conversion.
// Yes, C-style, just as we like.
//
// Usage:
//
...
//
// Now, x1 and x2 contains first and last 32 bytes of math.PI constant
// as Golang int32.
...
//
// WARNING!
// DESPITE, IT IS POSSIBLE TO CONVERT ADDRESS BACK AND CALL THE FUNCTION,
// THERE MIGHT BE SOME PROBLEMS WHEN YOU'RE TRYING TO WORK AROUND METHODS,
// NOT JUST FUNCTIONS. DO IT ON YOUR OWN RISK.
//
// WARNING!
// USING THIS FUNCTION (AND MECHANISM) IS VERY, VERY DANGEROUS.
// YOU MAY GET UNDEFINED BEHAVIOUR, PANIC, UNIVERSE COLLAPSE, ETC.
// AND IT DEPENDS ON THE GOLANG INTERNAL IMPLEMENTATIONS.
//
...
// Addr2Callable transforms an address of some function to that kind of address,
// you can cast to the typed pointer of some function, dereference it and call.
//
...
// obtained by TakeCallableAddr() to a simple, real,
// non-callable address of that function.
